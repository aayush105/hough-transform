...
image = cv2.imread("E:\Major\Hough_Transform\Hough-Transform-Implementation-master\ try.jpeg", 0)
...
img = cv2.imread("E:\Major\Hough_Transform\Hough-Transform-Implementation-master\ try.jpeg", 0)
...
coloredImage = cv2.imread("E:\Major\Hough_Transform\Hough-Transform-Implementation-master\ try.jpeg", 1)
# detectionKernel=np.asarray([[-1,-1,-1],[-1,8,-1],[-1,-1,-1]])
# binaryImage=image/255
FILE_SAVING_PATH = "E:\Major\Hough_Transform\Hough-Transform-Implementation-master"
